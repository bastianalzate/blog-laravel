...
@section('content')
    <div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
        <span class="text-xs uppercase text-gray-700 bg-gray-400 rounded-full px-2 py-2">Programacion</span>
        <h1 class="text-3xl text-white mt-4">Blog</h1>
        <p class="text-sm text-gray-400 mt-2">Proyecto web</p>

        <img src="{{ asset('images/dev.png') }}" class="absolute -right-20 -bottom-16 opacity-20">
    </div>
